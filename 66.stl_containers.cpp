/*
    This program demonstrates various STL containers in C++:
    ...
    Each section shows how to insert, access, and display elements.
*/
...
int main() {
    ...
    // 4️⃣ Set → Unique sorted elements
    set<int> s = {5, 1, 3, 5};  // duplicate ignored
    s.insert(2);
    cout << "Set elements: ";
    for (int x : s) cout << x << " ";
    cout << endl;
    ...
    // 7️⃣ Queue → FIFO (First In First Out)
    queue<int> q;
    q.push(1);
    q.push(2);
    q.push(3);
